            ...
            <div class="card">
                <div class="card-header d-sm-flex d-block">
                    <div class="mr-auto mb-sm-0 mb-3">
                        <h4 class="card-title mb-2">Blog Yönetimi</h4>
                        <span>Kurumunuza bağlı Blog yaılarını ekleme ve güncelleme işlemlerini yapabilirsiniz.</span>
                    </div>

                    <a href="blogekle" class="btn btn-info">+ Yeni Ekle</a>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex action-button">
                                            <a href="blogduzenle?id={{$blog['id']}}" class="btn btn-info btn-xs light px-2">
                                            ...
                                            <a href="blogsil?id={{$blog['id']}}" class="ml-2 btn btn-xs px-2 light btn-danger">
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
