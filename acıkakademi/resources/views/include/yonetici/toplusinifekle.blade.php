                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <h4 class="card-title">Toplu Sınıf Ekle</h4>
                            <hr>

                                <form action="{{route('orneksinifexcel')}}" method="post">
                                    @csrf
                                    <button type="submit" name="ornekexcel" class="btn btn-danger">ÖRNEK EXEL İÇİN TIKLAYIN</button>
                                </form>

                            <form action="{{route('toplusinifiekle')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="excelsinif">
                                </div>
                                <hr>
