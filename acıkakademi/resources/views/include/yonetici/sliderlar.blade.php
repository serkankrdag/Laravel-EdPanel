            ...
            <div class="card">
                <div class="card-header d-sm-flex d-block">
                    <div class="mr-auto mb-sm-0 mb-3">
                        <h4 class="card-title mb-2">Slider Yönetimi</h4>
                        <span>Kurumunuza bağlı Slider Reklam eklemelerini yapabilirsiniz.</span>
                    </div>

                    <a href="sliderekle" class="btn btn-info">+ Yeni Ekle</a>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex action-button">
                                            <a href="sliderduzenle?id={{$slider['id']}}" class="btn btn-info btn-xs light px-2">
                                            ...
                                            <a href="slidersil?id={{$slider['id']}}" class="ml-2 btn btn-xs px-2 light btn-danger">
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
