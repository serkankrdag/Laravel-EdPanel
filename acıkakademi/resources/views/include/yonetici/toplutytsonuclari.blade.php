                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <h4 class="card-title">TYT Sınav Yükleme İşlemleri</h4>
                            <hr>

                                <form action="{{route('ornektytexcel')}}" method="post">
                                    @csrf
                                    <a href="assets/upload/excel/1671954355962.xlsx" type="submit" name="ornekexcel" class="btn btn-danger">ÖRNEK EXEL İÇİN TIKLAYIN</a>
                                </form>


                            <form action="{{route('tytsonucuekle')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <a href="#">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="tytexcel">
                                </div>
