                                ...
                                <div class="card-body message-bx px-0 pt-3" >
                                    <div class="tab-content dz-scroll" id="message-bx">
                                        @foreach($ogrenciler as $ogrenci)
                                            @foreach(json_decode($kurum['sinif']) as $sinifim)
                                                @if($sinifim == $ogrenci['sinifId'])
                                                    <a href="mesajogretmen?id={{$ogrenci['id']}}">
                                                        <div class="chat-list-area" data-chat="person3">
                                                            ...
                                                            <div class="info-body">
                                                                <div class="d-flex">
                                                                    <h6 class="text-black user-name mb-0 font-w600 fs-16" data-name="Ad Soyad">{{$ogrenci['isim']}}</h6>
                                ...
                                <div class="message-bx chat-box">
                                    ...
                                    <div class="d-flex justify-content-between chat-box-header">
                                        <div class="d-flex align-items-center">
                                            ...
                                            @if(isset($ogrencisecili))
                                                <h5 class="text-black font-w500 mb-sm-1 mb-0 title-nm">{{$ogrencisecili['isim']}}</h5>
                                            @endif
                                        </div>
                                        <div class="d-flex align-items-center">
                                        ...
                                        <div class="chat-box-area dz-scroll" id="chartBox" style="background-image:url('images/chat-bg.png');">
                                            <div id="mesaj" data-chat="person2" class="chat active-chat">
                                                @foreach($mesajlar as $mesaj)
                                                    @if($mesaj->kullanici == session('ogretmen') && $mesaj->gonderen == 'ogretmen' && $mesaj->ogretmen==session('ogretmen'))
                                                    ...
                                                    @elseif($mesaj->ogretmen==session('ogretmen'))
                                    ...
                                    <div class="card-footer border-0 type-massage">
                                        <div class="input-group">
                                            ...
                                            <input id="id" type="hidden" class="form-control" value="{{session('ogretmen')}}"/>
                                            <input id="ogretmen" type="hidden" class="form-control" value="{{session('ogretmen')}}"/>
                                            @if(isset($ogrencisecili))
                                                <input id="ogrenci" type="hidden" class="form-control" value="{{$ogrencisecili['id']}}"/>
                                            @endif
