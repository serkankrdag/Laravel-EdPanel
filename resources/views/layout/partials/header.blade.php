@php
    ...
    $kullanici = sistemkullanicilari::find(session('id'));
@endphp
...
<head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="{{$siteayar['keywords']}}" />
    <meta name="author" content="İnovasyon Ajans" />
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <meta name="description" content="{{$siteayar['description']}}" />
    <meta property="og:title" content="Açık akademi" />
    <meta property="og:description" content="Açık akademi" />
    <meta property="og:image" content="./images/logo.png" />
    <meta name="format-detection" content="telephone=no">
    <title>{{$siteayar['title']}}</title>
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset("/")}}assets/upload/logos/{{$siteayar['favicon']}}">
        ...
        <div class="header-content">
                    ...
                    <ul class="navbar-nav header-right main-notification">
                        ...
                        <li class="nav-item dropdown header-profile">
                            <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                ...
                                @if($kullanici['resim']!='')
                                    <img src="{{asset("/")}}assets/images/user.png" width="20">
                                @else
                                    <img src="{{asset("/")}}assets/upload/avatar/{{$kullanici['resim']}}" width="20">
                                @endif
                                ...
                                <div class="header-info">
                                    ...
                                    @elseif($kullanici['yetki']==2)
                                        <small>Yönetici Paneli</small>
                                    @elseif($kullanici['yetki']==3)
                                        <small>Öğretmen Paneli</small>
                                    @elseif($kullanici['yetki']==4)
            ...
            <div class="sub-header">
                <div class="d-flex align-items-center flex-wrap mr-auto">
                    <h5 class="dashboard_bar">Gösterge Paneli</h5>
                </div>
                <div class="d-flex align-items-center">
                    <a target="_blank" href="{{$siteayar['facebook']}}" class="btn btn-facebook btn-facebook light mr-1">
                        <i class="fa fa-facebook"></i></a>
                    <a target="_blank" href="{{$siteayar['instagram']}}" class="btn btn-instagram btn-instagram light mr-1">
                        <i class="fa fa-instagram"></i></a>
                    <a target="_blank" href="{{$siteayar['linkedin']}}" class="btn btn-linkedin btn-linkedin light mr-1">
                        <i class="fa fa-linkedin"></i></a>
                    <a target="_blank" href="{{$siteayar['youtube']}}" class="btn btn-youtube btn-youtube light mr-1">
    ...
    <div class="deznav">
        <div class="deznav-scroll">
            <div class="main-profile">
                ...
                <h6 class="name"><span class="font-w300">
                <b>{{$kullanici['isim']}}</b>
                <br>
                    @if($kullanici['yetki']==1)
                            <small>Admin Paneline Hoşgeldiniz</small>
                        @elseif($kullanici['yetki']==2)
                            <small>Yönetici Paneline Hoşgeldiniz</small>
                        @elseif($kullanici['yetki']==3)
                            <small>Öğretmen Paneline Hoşgeldiniz</small>
                        @elseif($kullanici['yetki']==4)
                            <small>Öğrenci Paneline Hoşgeldiniz</small>
                        @endif
                    </span> </h6>
