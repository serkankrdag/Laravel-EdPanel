                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('etkinligiekleogretmen')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" multiple id="exampleInputFile" class="form-control" name="resimler[]" >
                                </div>
