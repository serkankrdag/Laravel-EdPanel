        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles mx-0">
                ...
                @foreach($etkinlikler as $etkinlik)
                    @foreach($sinifId as $sinif)
                        @foreach(json_decode($etkinlik['sinifId']) as $etkinliksinif)
                            @php($control[0] = 0)
                            @if($etkinliksinif == $sinif && !in_array($etkinlik['id'], $control))
                                @php($control[] = $etkinlik['id'])
                                <div class="col-xl-3">
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            {{$etkinlik['detay']}}<br><br>s
                                            <div class="d-flex action-button">
                                                <a href="etkinlikduzenleogretmen?id={{$etkinlik['id']}}" class="btn btn-info btn-xs light px-2">
