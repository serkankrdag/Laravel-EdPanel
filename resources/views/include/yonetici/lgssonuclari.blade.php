            ...
            <div class="card">
                <div class="card-header d-sm-flex d-block">
                    <div class="mr-auto mb-sm-0 mb-3">
                        <h4 class="card-title mb-2">LGS Sınav Sonuçları</h4>
                        <span>Kurumunuza bağlı LGS Sınav Sonuçlarını yükleme ve görüntüleme işlemleri yapabilirsiniz.</span>
                    </div>
                    <a href="toplulgssonuclari" class="btn btn-info light mr-3"><i class="las la-download scale3 mr-2"></i>Sınav Yükle</a>
                </div>
                <div class="card-body">
