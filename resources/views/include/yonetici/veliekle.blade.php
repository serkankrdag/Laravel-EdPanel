                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <h4 class="card-title">Veli Ekle</h4>
                            <hr>


                            <form action="{{route('veliyiekle')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="adres" id="adres" cols="200" rows="10"></textarea>
                                </div>
