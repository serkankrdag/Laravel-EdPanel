                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <h4 class="card-title">Toplu Ders Programı Ekle</h4>
                            <hr>

                            <form action="{{route('ornekdersexcel')}}" method="post">
                                @csrf
                                <button type="submit" name="ornekexcel" class="btn btn-danger">ÖRNEK EXEL İÇİN TIKLAYIN</button>
                            </form>

                            <form action="{{route('topludersiekle')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="exceldersler">
                                </div>
                                <hr>
