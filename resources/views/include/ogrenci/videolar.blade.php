            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="form-group">
                        <select type="search" class="form-control default-select form-control-lg select-table-filter" data-table="order-table">
                            <option value="0">Tüm Konular</option>
                            @foreach($konular as $konu)
                                <option name="videofiltre" value="{{$konu['isim']}}">{{$konu['isim']}}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                @foreach($videolar as $video)
                    @foreach(json_decode($video['sinifId']) as $videosinif)
                        @if($videosinif == $ogrenci['sinifId'])
                                                    ...
                                                    <div class="card-body">
                                                        <div class="d-flex mb-4 align-items-start">
                                                            <div class="dz-media mr-3">
                                                                <a href="videodetayogrenci?id={{$video['id']}}" class="text-black">
